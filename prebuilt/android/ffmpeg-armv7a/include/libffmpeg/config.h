...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-libx264 --enable-libass --disable-nonfree --enable-runtime-cpudetect --disable-gray --enable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=aac --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=pcm_s16le --enable-decoder=pcm_f32le --enable-decoder=png --enable-decoder=subrip --disable-hwaccels --disable-muxers --enable-muxer=mp3 --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=concat --disable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --disable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=wav --enable-demuxer=image2 --enable-demuxer=image_png_pipe --enable-demuxer=matroska --enable-demuxer=avi --enable-demuxer=srt --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=png --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --disable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --disable-protocol=rtmp --disable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-protocol=pipe --disable-protocol=cache --disable-protocol=data --disable-protocol=hls --enable-protocol=file --disable-protocol=tcp --disable-protocol=udplite --disable-protocol=udp --disable-devices --enable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --enable-gpl --enable-encoder=libx264 --enable-encoder=libx264rgb --prefix=/home/jsyan/workspace/ijk/android/contrib/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --disable-debug --enable-small --pkg-config=/usr/bin/pkg-config --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/jsyan/workspace/ijk/android/contrib/build/x264-armv7a/output/include -I/home/jsyan/workspace/ijk/android/contrib/build/ffmpeg-extra-armv7a/output/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/home/jsyan/workspace/ijk/android/contrib/build/x264-armv7a/output/lib -lx264 -L/home/jsyan/workspace/ijk/android/contrib/build/ffmpeg-extra-armv7a/output/lib -lass -lfribidi -lfreetype -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/home/jsyan/workspace/ijk/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/jsyan/workspace/ijk/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
