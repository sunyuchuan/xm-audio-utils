...
valgrind --leak-check=full --log-file=valgrind_log/test_audio_encoder.log  ./tests/test_audio_encoder ../data/pcm_mono_44kHz_0035.mp4 mono_0035_encoder.mp4
...
valgrind --leak-check=full --log-file=valgrind_log/test_xm_audio_utils_mix.log ./tests/test_xm_audio_utils_mix ../data/web_effect_config.txt 44100 utils_mix_side_chain_test.pcm
...
echo -e "\033[1;43;30m\ntest_xm_audio_generator...\033[0m"
valgrind --leak-check=full --log-file=valgrind_log/test_xm_audio_generator_phone.log ./tests/test_xm_audio_generator ../data/phone_effect_config.txt phone_generator_pcm_mono_44kHz_0035.m4a
...
echo -e "\n"
cat valgrind_log/test_xm_audio_generator_phone.log
echo -e "\n"
